...
class PaymentSourcePrzelewytwofour extends AbstractPaymentSource
{
    /**
     * @var Type $type
     */
    ...
    public function __construct(Type $type, Bic $bic = null, EmulateCode $emulateCode = null, Mid $mid = null)
    {
        $this->type = $type;
        $this->bic = $bic;
