...
use Centrobill\Sdk\Entity\PaymentSource\PaymentSourceEps;
...
class PaymentSourceEpsTest extends TestCase
{
    private PaymentSourceEps $paymentSource;

    public function testConstruct()
    {
        $this->createEntity();
        self::assertInstanceOf(PaymentSourceEps::class, $this->paymentSource);
    }
    ...
    {
        $this->paymentSource = new PaymentSourceEps(
            new Bic('12345678'),
